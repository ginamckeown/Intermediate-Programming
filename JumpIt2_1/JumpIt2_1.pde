...
void setup() {
  ...
  for(int i = 0; i < platform.length; i++){
   ...
   //-------> don't create timer until game starts
  // Create timer
  //timer = new Timer();
...
void displayGame() {
  if (gameOpen) {
    ...
    int platformSpacing = 80;
    platform[0].setSpeedTo(2);
    if (platform[0].getX() < width - platform[0].getW() - platformSpacing) {
      platform[1].setSpeedTo(2);
    } else if (platform[1].getX() < width - platform[1].getW() - platformSpacing) {
      platform[2].setSpeedTo(2);
    } else if (platform[2].getX() < width - platform[2].getW() - platformSpacing) {
      platform[0].setSpeedTo(2);
    } 
